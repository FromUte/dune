...
describe Projects::FaqsController do
  ...
  describe "POST create" do
    before{ post :create, project_id: faq.project, locale: 'fr', project_faq: {title: 'title', answer: 'answer'} }
  ...
  describe "DELETE destroy" do
    before { delete :destroy, project_id: faq.project, id: faq.id, locale: 'fr' }
