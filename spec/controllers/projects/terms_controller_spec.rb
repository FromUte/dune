...
describe Projects::TermsController do
  ...
  describe "POST create" do
    before{ post :create, project_id: document.project, locale: 'fr', project_document: { name: 'some name', document: file } }
  ...
  describe "DELETE destroy" do
    before { delete :destroy, project_id: document.project, id: document, locale: 'fr' }
